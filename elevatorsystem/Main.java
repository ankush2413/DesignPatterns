...
public class Main {
    public static void main(String [] args)
    {
        ...
        ElevatorController obj = new ElevatorController();

        obj.requestElevator(8, RequestType.PICKUP_UP);
        obj.requestElevator(7, RequestType.PICKUP_DOWN);
        obj.requestElevator(2, RequestType.PICKUP_DOWN);
